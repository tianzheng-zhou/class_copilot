...
来源：[schemas.py](../class_copilot/api/schemas.py)、[routes.py](../class_copilot/api/http/routes.py)、[error_handlers.py](../class_copilot/api/http/error_handlers.py)、[types.ts](../frontend/src/api/types.ts)。
...
来源：[handlers.py](../class_copilot/api/ws/handlers.py)、[connection.py](../class_copilot/api/ws/connection.py)、[messages.ts](../frontend/src/ws/messages.ts)。
...
来源：[settings.py](../class_copilot/application/settings.py)、[config.py](../class_copilot/config.py)、[session.py](../class_copilot/application/session.py)。
...
来源：[orm.py](../class_copilot/infrastructure/persistence/orm.py)、[repositories.py](../class_copilot/infrastructure/persistence/repositories.py)、[db.py](../class_copilot/db.py)。
